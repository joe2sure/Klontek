  ...
  return (
    <section className="portfolio-container">
      <Fade direction="right">
        <TextHeader
          subtitle="Our Selected Project"
          title="Let us elevate your business to new heights with our exceptional results."
        />
      </Fade>

      <div className="portfolio-grid">
        {data.map((item, index) => (
          <Fade direction="up" bottom delay={500 * index} key={index}>
      ...
      <Fade bottom>
        ...
        >
          <div className="portfolio-see-more-content">
            <p className="portfolio-see-more-text">See More</p>
            <svg
              className="portfolio-see-more-icon"
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            ...
            <svg
              className="portfolio-see-more-icon portfolio-see-more-icon-offset"
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
